...
# Ground Truth来源优先级（补全日志里出现的来源，越小优先级越高）
SOURCE_PRIORITY = {
    'NIST': 1,
    'Wordfence': 2,
    'GitHub': 3,
...
def main():
    ...
    print("="*80)
    print("MULTI-MODEL CVSS PREDICTION EXPERIMENT (Fixed)")
    print("="*80)
    ...
    for model_name, model in MODELS_TO_TEST.items():
        ...
        for cve_id in progress_bar:
            ...
            # 读取报告
            report_file = os.path.join(REPORT_DIR, f"{cve_id}_enhanced_report.txt")
